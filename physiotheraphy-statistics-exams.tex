...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, coltitle=black, breakable, bottomrule=.15mm, colback=white, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, titlerule=0mm, arc=.35mm, toprule=.15mm, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, left=2mm]
