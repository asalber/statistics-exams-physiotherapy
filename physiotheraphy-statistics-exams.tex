...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, interior hidden, enhanced, frame hidden, boxrule=0pt, sharp corners, breakable]}{\end{tcolorbox}}\fi
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(x, y, }\AttributeTok{main=}\StringTok{"Scatter plot of warm{-}up time and injuries"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"Warm{-}up time"}\NormalTok{, }\AttributeTok{ylab=}\StringTok{"Injuries"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{img/exam2018-05-31/scatterplot-injuries-warm-up-1.pdf}
